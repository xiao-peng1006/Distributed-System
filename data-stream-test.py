...
# Test data: 42000/3 = 14000
test_input = [
    json.dumps({'Timestamp': '1526900000001', 'Symbol': 'BTC-USD', 'LastTradePrice': '10000'}),
    json.dumps({'Timestamp': '1526900000001', 'Symbol': 'BTC-USD', 'LastTradePrice': '12000'}),
    json.dumps({'Timestamp': '1526900000001', 'Symbol': 'BTC-USD', 'LastTradePrice': '20000'}),
]
